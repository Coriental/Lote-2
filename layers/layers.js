...
//ol.proj.get("EPSG:32721").setExtent([440218.013580, 7199970.747663, 451676.934093, 7205955.120346]);
var wms_layers = [];
...
var format_PostacionL2Exist02092025_6 = new ol.format.GeoJSON();
var features_PostacionL2Exist02092025_6 = format_PostacionL2Exist02092025_6.readFeatures(json_PostacionL2Exist02092025_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL2Exist02092025_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL2Exist02092025_6.addFeatures(features_PostacionL2Exist02092025_6);
var lyr_PostacionL2Exist02092025_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL2Exist02092025_6, 
                style: style_PostacionL2Exist02092025_6,
                popuplayertitle: 'Postacion L2 Exist 02-09-2025',
                interactive: true,
                title: '<img src="styles/legend/PostacionL2Exist02092025_6.png" /> Postacion L2 Exist 02-09-2025'
            });
var format_PostacionL2Nuevo02092025_7 = new ol.format.GeoJSON();
var features_PostacionL2Nuevo02092025_7 = format_PostacionL2Nuevo02092025_7.readFeatures(json_PostacionL2Nuevo02092025_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PostacionL2Nuevo02092025_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PostacionL2Nuevo02092025_7.addFeatures(features_PostacionL2Nuevo02092025_7);
var lyr_PostacionL2Nuevo02092025_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PostacionL2Nuevo02092025_7, 
                style: style_PostacionL2Nuevo02092025_7,
                popuplayertitle: 'Postacion L2 Nuevo 02-09-2025',
                interactive: true,
                title: '<img src="styles/legend/PostacionL2Nuevo02092025_7.png" /> Postacion L2 Nuevo 02-09-2025'
            });
...
var lyr_AP_8 = new ol.layer.Vector({
                ...
                popuplayertitle: 'AP',
                interactive: true,
                title: '<img src="styles/legend/AP_8.png" /> AP'
            });
...
var format_PDL2_14 = new ol.format.GeoJSON();
var features_PDL2_14 = format_PDL2_14.readFeatures(json_PDL2_14, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_PDL2_14 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PDL2_14.addFeatures(features_PDL2_14);
var lyr_PDL2_14 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PDL2_14, 
                style: style_PDL2_14,
                popuplayertitle: 'PD.L2',
                interactive: true,
                title: '<img src="styles/legend/PDL2_14.png" /> PD.L2'
            });
var format_FichaPDL2Sist02072025_15 = new ol.format.GeoJSON();
var features_FichaPDL2Sist02072025_15 = format_FichaPDL2Sist02072025_15.readFeatures(json_FichaPDL2Sist02072025_15, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32721'});
var jsonSource_FichaPDL2Sist02072025_15 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_FichaPDL2Sist02072025_15.addFeatures(features_FichaPDL2Sist02072025_15);
var lyr_FichaPDL2Sist02072025_15 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_FichaPDL2Sist02072025_15, 
                style: style_FichaPDL2Sist02072025_15,
                popuplayertitle: 'Ficha PD L2 Sist 02-07-2025',
                interactive: true,
                title: '<img src="styles/legend/FichaPDL2Sist02072025_15.png" /> Ficha PD L2 Sist 02-07-2025'
            });
...
var group_Lote2 = new ol.layer.Group({
                                layers: [lyr_PDL2_14,lyr_FichaPDL2Sist02072025_15,],
                                fold: 'close',
                                title: 'Lote 2'});
...
var group_LOTE1 = new ol.layer.Group({
                                ...
                                title: 'LOTE 1'});
var group_LOTE2 = new ol.layer.Group({
                                layers: [lyr_postesExistentesLote2_2,lyr_PostacinfichasL22808_3,lyr_PostacionSistL2Exist26082025_4,lyr_PostacionSistL2Nuevo26082025_5,lyr_PostacionL2Exist02092025_6,lyr_PostacionL2Nuevo02092025_7,],
                                fold: 'close',
                                title: 'LOTE 2'});
...
lyr_GoogleHybrid_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_postesExistentesLote2_2.setVisible(true);lyr_PostacinfichasL22808_3.setVisible(true);lyr_PostacionSistL2Exist26082025_4.setVisible(true);lyr_PostacionSistL2Nuevo26082025_5.setVisible(true);lyr_PostacionL2Exist02092025_6.setVisible(true);lyr_PostacionL2Nuevo02092025_7.setVisible(true);lyr_AP_8.setVisible(true);lyr_MT240L2Subterrneo_9.setVisible(true);lyr_BT3x701x501x25_10.setVisible(true);lyr_MT3x35L2_11.setVisible(true);lyr_MT3x70L2_12.setVisible(true);lyr_MT3x185L2_13.setVisible(true);lyr_PDL2_14.setVisible(true);lyr_FichaPDL2Sist02072025_15.setVisible(true);
...
lyr_PostacionL2Exist02092025_6.set('fieldAliases', {'LATITUD': 'LATITUD', 'LONGITUD': 'LONGITUD', 'ALIMENTADOR': 'ALIMENTADOR', 'NRO_SOSTEN': 'NRO_SOSTEN', 'TIPO_POSTE': 'TIPO_POSTE', });
lyr_PostacionL2Nuevo02092025_7.set('fieldAliases', {'LATITUD': 'LATITUD', 'LONGITUD': 'LONGITUD', 'ALIMENTADOR': 'ALIMENTADOR', 'NRO_SOSTEN': 'NRO_SOSTEN', 'TIPO_POSTE': 'TIPO_POSTE', });
lyr_AP_8.set('fieldAliases', {'Fecha': 'Fecha', 'alimentador': 'alimentador', 'Nro de sosten': 'Nro de sosten', 'contratista': 'contratista', 'x': 'x', 'y': 'y', });
...
lyr_PDL2_14.set('fieldAliases', {'Item': 'Item', 'Certificado': 'Certificado', 'ESTADO': 'ESTADO', 'Contratista': 'Contratista', 'Fecha de montaje': 'Fecha de montaje', 'CANTIDAD': 'CANTIDAD', 'Sigla PD': 'Sigla PD', 'OT N°': 'OT N°', 'Alimentador': 'Alimentador', 'Nro de Sosten': 'Nro de Sosten', 'Dirección': 'Dirección', 'Ciudad': 'Ciudad', 'Coordenada X': 'Coordenada X', 'Coordenada Y': 'Coordenada Y', 'N° Ande': 'N° Ande', 'N° Fabrica': 'N° Fabrica', 'Marca': 'Marca', 'Potencia': 'Potencia', 'Descargador': 'Descargador', 'Corriente Nominal': 'Corriente Nominal', 'Seccionador MT': 'Seccionador MT', 'Fusible Cartucho MT': 'Fusible Cartucho MT', 'Seccionador BT': 'Seccionador BT', 'Fusible NH': 'Fusible NH', 'SPAT (Ohm)': 'SPAT (Ohm)', 'Fecha en servicio': 'Fecha en servicio', 'Hora': 'Hora', });
lyr_FichaPDL2Sist02072025_15.set('fieldAliases', {'Tipo de Poste': 'Tipo de Poste', 'Numero de Sosten': 'Numero de Sosten', 'Alimentadores Lote 2': 'Alimentadores Lote 2', 'Nro de Fabrica del trafo': 'Nro de Fabrica del trafo', 'N�ANDE': 'N�ANDE', 'Longitud': 'Longitud', 'Latitud': 'Latitud', });
...
lyr_PostacionL2Exist02092025_6.set('fieldImages', {'LATITUD': 'TextEdit', 'LONGITUD': 'TextEdit', 'ALIMENTADOR': 'TextEdit', 'NRO_SOSTEN': 'TextEdit', 'TIPO_POSTE': 'TextEdit', });
lyr_PostacionL2Nuevo02092025_7.set('fieldImages', {'LATITUD': 'TextEdit', 'LONGITUD': 'TextEdit', 'ALIMENTADOR': 'TextEdit', 'NRO_SOSTEN': 'TextEdit', 'TIPO_POSTE': 'TextEdit', });
lyr_AP_8.set('fieldImages', {'Fecha': 'TextEdit', 'alimentador': 'TextEdit', 'Nro de sosten': 'Range', 'contratista': 'TextEdit', 'x': 'Range', 'y': 'Range', });
...
lyr_PostacionL2Exist02092025_6.set('fieldLabels', {'LATITUD': 'no label', 'LONGITUD': 'no label', 'ALIMENTADOR': 'no label', 'NRO_SOSTEN': 'no label', 'TIPO_POSTE': 'no label', });
lyr_PostacionL2Nuevo02092025_7.set('fieldLabels', {'LATITUD': 'no label', 'LONGITUD': 'no label', 'ALIMENTADOR': 'no label', 'NRO_SOSTEN': 'no label', 'TIPO_POSTE': 'no label', });
lyr_AP_8.set('fieldLabels', {'Fecha': 'inline label - visible with data', 'alimentador': 'inline label - visible with data', 'Nro de sosten': 'inline label - visible with data', 'contratista': 'inline label - visible with data', 'x': 'inline label - visible with data', 'y': 'inline label - visible with data', });
